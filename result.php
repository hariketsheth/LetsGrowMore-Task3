                    ...
                    <div class="main-page">
                        <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-12">
                                    <h2 class="title" align="center">Yayyy, Congratulations</h2>
                                </div>
                            </div>
                            <!-- /.row -->
...
<tr>
                                                <th scope="row" colspan="2">Percntage</th>           
                                                            <td><b><?php echo  round(htmlentities($totlcount*(100)/$outof),2); ?> %</b></td>
                                                             </tr>
<tr>
                                                <th scope="row" colspan="2">GPA</th>           
                                                            <td><b><?php echo  round(htmlentities($totlcount*(100)/$outof),1)/10; ?> </b></td>
                                                             </tr>
