...
<div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="col-sm-offset-2 col-sm-10">
                                                            <button type="submit" name="submit" id="submit" class="btn btn-primary">Add Result</button>
                                                             <a href="manage-results.php"><button type="button"  class="btn btn-danger">Manage Results</button></a>
                                                        </div>
                                                    </div>
                                                </form>
