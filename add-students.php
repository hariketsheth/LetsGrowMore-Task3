...
$classid=$_POST['class']; 
$status=1;
$sql="INSERT INTO  tblstudents(StudentName,RollId,StudentEmail,Gender,ClassId,Status) VALUES(:studentname,:roolid,:studentemail,:gender,:classid,:status)";
                                                    ...
                                                    <div class="form-group">
                                                        <div class="col-sm-offset-2 col-sm-10">
                                                            <button type="submit" name="submit" class="btn btn-primary">Add</button>
                                                             <a href="manage-students.php"><button type="button"  class="btn btn-danger">Manage Students</button></a>
                                                        </div>
                                                    </div>
                                                </form>
