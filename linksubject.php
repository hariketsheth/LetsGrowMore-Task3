                    ...
                    <div class="main-page">
                     ...
                     <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-6">
                                    <h2 class="title">Link Subject to Class</h2>
                            ...
                            <div class="row breadcrumb-div">
                                <div class="col-md-6">
                                    <ul class="breadcrumb">
                                        ...
                                        <li> Subjects</li>
                                        <li class="active">Link Subject to Class</li>
                                    </ul>
                                </div>
                                                    ...
                                                    <div class="form-group">
                                                        <div class="col-sm-offset-2 col-sm-10">
                                                            <button type="submit" name="submit" class="btn btn-primary">Add</button>
                                                             <a href="manage-links.php"><button type="button"  class="btn btn-danger">Manage Subject Links</button></a>
                                                        </div>
                                                    </div>
                                                </form>
